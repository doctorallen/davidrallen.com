      ...
      <ol className="timeline">
        <li>
          ...
          <ul>
            ...
            <li>
              [EDUCATION] Started learning <strong>Photoshop</strong>
            </li>
          </ul>
        </li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>[PROJECT] Built second website using Flash</li>
          </ul>
        </li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              [PROJECT] Programmed "breakout" inspired video game using Visual
